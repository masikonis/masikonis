	...
	return (
		<div className="py-8">
			<div className="xl:max-w-10xl">
				...
				<p className="mb-4 font-sans text-gray-800 text-base xl:text-base">I keep up with the latest technology, playing a vital role in integrating artificial intelligence into our work. At Single Grain and for our clients, I'm leading the effort to incorporate AI into our current operations and the services we offer.</p>
