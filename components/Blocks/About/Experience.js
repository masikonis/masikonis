	...
	return (
		<div className="py-8">
			<div className="xl:max-w-10xl">
				...
				<p className="mb-8 font-sans text-gray-800 text-base xl:text-base">My roles as a lead developer, web consultant, and advisor to companies in diverse sectors have honed my ability to think on my feet and solve problems under pressure. I love working directly with founders and small teams, contributing to product development, growth strategies, and AI-driven solutions.</p>
				...
				<h2 className="mb-4 font-serif text-gray-800 text-lg md:text-xl">Single Grain</h2>
				<p className="mb-4 font-sans text-gray-800 text-base xl:text-base">Single Grain is a digital marketing agency working with clients like Uber, Amazon, Lyft, SalesForce, and AirBnB. I was first hired to manage all the company's web properties and report directly to the CEO, Eric Siu, known best for his Marketing School podcast with Neil Patel.</p>
				<p className="mb-4 font-sans text-gray-800 text-base xl:text-base">My main skill was web development, but working closely with expert marketers taught me a lot about digital marketing quickly. I was then asked to be part of the Growth Team, which focused on expanding Eric's personal brand and new projects. We followed a 'lean startup' approach, which meant I had to learn new skills fast and find solutions to problems working with limited resources.</p>
				<p className="mb-4 font-sans text-gray-800 text-base xl:text-base">I keep up with the latest technology, playing a vital role in <strong>integrating artificial intelligence</strong> into our work. At Single Grain and for our clients, I'm leading the effort to incorporate AI into our current operations and the services we offer.</p>
				...
				<p className="mb-6 font-sans text-gray-800 text-base xl:text-base">Generation Genius was the <strong>#1 Fastest Growing Education Company in America</strong>, according to the 2022 Inc5000 list, with a revenue growth of 4,891% from 2018 to 2021. It also earned a spot on TIME Magazine's list of the <strong>100 Most Influential Companies</strong> in the World for 2023. This prestigious recognition has us sharing the list with household names such as Apple, SpaceX, OpenAI, and Nvidia.</p>
			</div>
		</div>
	);
};
