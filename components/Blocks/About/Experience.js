	...
	return (
		<div className="py-8">
			<div className="xl:max-w-10xl">
				...
				<p className="mb-6 font-sans text-gray-800 text-base xl:text-base">Generation Genius has been ranked the <strong>#1 Fastest Growing Education Company in America</strong> on the 2022 Inc5000 list based on exceptional revenue growth rate of 4,891% from 2018 to 2021.</p>
