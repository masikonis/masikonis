	...
	return (
		<div className="py-6 xl:py-0 pb-8">
			...
			<h3 className="mt-3 font-serif text-white text-xl">
				{"Hi, my name is Nerijus 👋 I’m a"} <strong className="font-bold">{"developer"}</strong> {"who combines hands-on technical skills with marketing and AI experience to help early-stage U.S. companies grow faster."}
			</h3>
			<ul className="mt-10">
